    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(to='projects.Tag')),
            ],
        ),
        migrations.CreateModel(
            name='TypeProject2',
            ...
            options={
                'ordering': ['sort'],
                'verbose_name': '\u0422\u0438\u043f \u043f\u0440\u043e\u0435\u043a\u0442\u0430 2',
                'verbose_name_plural': '\u0422\u0438\u043f\u044b \u043f\u0440\u043e\u0435\u043a\u0442\u043e\u0432 2',
            },
        ),
        migrations.AddField(
            model_name='project',
            name='tags',
            field=models.ManyToManyField(to='projects.Tag', through='projects.TagProject'),
        ),
        migrations.AddField(
            model_name='planproject',
            name='project',
            field=models.ForeignKey(verbose_name='\u043f\u0440\u043e\u0435\u043a\u0442', to='projects.Project'),
        ),
        migrations.AddField(
