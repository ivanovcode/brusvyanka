$(document).ready(function() {
    ...
    cols = $('#photoproject_set-group tbody tr:first').children()
    ...
    $("#photoproject_set-group table tbody .form-row td").css('maxHeight', '300px');
    $("#photoproject_set-group table tbody .form-row td").css('height', '300px');
    $("#photoproject_set-group table tbody textarea").css('width', '580px');

    $("#photoproject_set-group table tbody").sortable({
        axis: 'y',
        items: 'tr',
        cursor: 'move',
	placeholder: "ui-state-highlight",
	    ...
	    $('#photoproject_set-group table tbody textarea').each(function () {
	      initTinyMCE($(this));
	    });
        },
	start: function() {
