function textarea_init() {
  $('textarea').not("#id_footer_body").tinymce({
	...
	extended_valid_elements : "a[class|name|href|target|title|onclick],img[class|src|border=0|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name],hr[class|width|size|noshade],font[face|size|color|style],span[class|align|style],div[class|align|style],object[width|height|classid|codebase],param[name|value],embed[src|type|width|height|flashvars|wmode]",
	fullscreen_settings : {
